...
describe('Region e2e test', () => {
  ...
  it('should load Regions', async () => {
    ...
    expect(await regionComponentsPage.getTitle()).to.eq('ecm2018LegacyApp.region.home.title');
  ...
  it('should load create Region page', async () => {
    ...
    expect(await regionUpdatePage.getPageTitle()).to.eq('ecm2018LegacyApp.region.home.createOrEditLabel');
  ...
  it('should delete last Region', async () => {
    ...
    expect(await regionDeleteDialog.getDialogTitle()).to.eq('ecm2018LegacyApp.region.delete.question');
