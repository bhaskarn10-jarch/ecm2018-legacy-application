...
describe('Department e2e test', () => {
  ...
  it('should load Departments', async () => {
    ...
    expect(await departmentComponentsPage.getTitle()).to.eq('ecm2018LegacyApp.department.home.title');
  ...
  it('should load create Department page', async () => {
    ...
    expect(await departmentUpdatePage.getPageTitle()).to.eq('ecm2018LegacyApp.department.home.createOrEditLabel');
  ...
  it('should delete last Department', async () => {
    ...
    expect(await departmentDeleteDialog.getDialogTitle()).to.eq('ecm2018LegacyApp.department.delete.question');
