...
describe('Task e2e test', () => {
  ...
  it('should load Tasks', async () => {
    ...
    expect(await taskComponentsPage.getTitle()).to.eq('ecm2018LegacyApp.task.home.title');
  ...
  it('should load create Task page', async () => {
    ...
    expect(await taskUpdatePage.getPageTitle()).to.eq('ecm2018LegacyApp.task.home.createOrEditLabel');
  ...
  it('should delete last Task', async () => {
    ...
    expect(await taskDeleteDialog.getDialogTitle()).to.eq('ecm2018LegacyApp.task.delete.question');
