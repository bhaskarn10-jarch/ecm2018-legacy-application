...
describe('Employee e2e test', () => {
  ...
  it('should load Employees', async () => {
    ...
    expect(await employeeComponentsPage.getTitle()).to.eq('ecm2018LegacyApp.employee.home.title');
  ...
  it('should load create Employee page', async () => {
    ...
    expect(await employeeUpdatePage.getPageTitle()).to.eq('ecm2018LegacyApp.employee.home.createOrEditLabel');
  ...
  it('should delete last Employee', async () => {
    ...
    expect(await employeeDeleteDialog.getDialogTitle()).to.eq('ecm2018LegacyApp.employee.delete.question');
