...
describe('JobHistory e2e test', () => {
  ...
  it('should load JobHistories', async () => {
    ...
    expect(await jobHistoryComponentsPage.getTitle()).to.eq('ecm2018LegacyApp.jobHistory.home.title');
  ...
  it('should load create JobHistory page', async () => {
    ...
    expect(await jobHistoryUpdatePage.getPageTitle()).to.eq('ecm2018LegacyApp.jobHistory.home.createOrEditLabel');
  ...
  it('should delete last JobHistory', async () => {
    ...
    expect(await jobHistoryDeleteDialog.getDialogTitle()).to.eq('ecm2018LegacyApp.jobHistory.delete.question');
